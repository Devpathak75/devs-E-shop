			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<li><a href="index.jsp?type=mobile">Mobile</a></li>
						...
						<li><a href="index.jsp?type=speaker">Speaker</a></li>
						<li><a href="index.jsp?type=tablet">Tablet</a></li>
						<li><a href="index.jsp?type=cooler">Cooler</a></li>
						<li><a href="index.jsp?type=fan">Fan</a></li>
						<li><a href="index.jsp?type=Headphone">Headphone</a></li>
						</ul></li>
				</ul>
			</div>
		</div>
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<li><a href="userHome.jsp?type=speaker">Speaker</a></li>
						...
						<li><a href="userHome.jsp?type=Headphone">Headphone</a></li>
						</ul></li>
					<%
					if (notf == 0) {
					%>
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<li><a href="adminViewProduct.jsp?type=mobile">Mobile</a></li>
						...
						<li><a href="adminViewProduct.jsp?type=speaker">Speaker</a></li>
						...
						<li><a href="adminViewProduct.jsp?type=Headphone">Headphone</a></li>
						</ul></li>
					<li><a href="adminStock.jsp">Stock</a></li>
					<li><a href="shippedItems.jsp">Shipped</a></li>
					<li><a href="unshippedItems.jsp">Orders</a></li>
					<li class="dropdown"><a class="dropdown-toggle"
						data-toggle="dropdown" href="#">Update The Items <span
							class="caret"></span>
					</a>
						<ul class="dropdown-menu">
							<li><a href="addProduct.jsp">Add The Product</a></li>
							<li><a href="removeProduct.jsp">Remove The Product</a></li>
							<li><a href="updateProductById.jsp">Update The Product</a></li>
						</ul></li>
					<li><a href="./LogoutSrv">Logout</a></li>
				</ul>
			</div>
